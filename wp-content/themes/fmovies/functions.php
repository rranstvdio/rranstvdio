...
function fmovies_register_block_styles() {

	register_block_style(
		'core/button',
		array(
			'name'  => 'btn',
			'label' => __( 'Hover Effect', 'fmovies' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tgroup',
			'label' => __( 'Margin Bottom Space', 'fmovies' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tsociallinks',
			'label' => __( 'Square', 'fmovies' ),
		)
	);
}
add_action( 'init', 'fmovies_register_block_styles' );
